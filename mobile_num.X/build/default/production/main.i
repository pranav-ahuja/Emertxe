...
void main(void) {
    init_config();
    clcd_putstr("Enter Mobile Num", (0x80 + 0));
...
void display(unsigned char key)
{
    if(key != 0xFF)
    {
        ...
        switch(key)
        {
            ...
            case'#':
                clcd_putstr("                ", (0xC0 + 0));
                clcd_putch(key, (0xC0 + 8));
                break;
            default:
                clcd_putstr("                ", (0xC0 + 0));
                clcd_putch(key + '0', (0xC0 + 8));
        }

    }
    else{
        clcd_putstr("No key pressed", (0xC0 + 0));
    }
}
