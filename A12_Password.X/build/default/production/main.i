    ...
    while (1) {
        ...
        if(flag1 == 0)
        {
            ...
            else if(count == 8 && count1 == count)
            {
                ...
                clcd_print("Excellent! You",(0x80 + 1));
                clcd_print("Cracked the Code",(0xC0 + 0));
            ...
            else if(count == 8 && count1 != count)
            {
                ...
                clcd_write(0x01, 0);
                clcd_write(0x0C, 0);
                clcd_print("Attempt",(0x80 + 0));
                clcd_print(ptr,(0x80 + 9));
                ptr[0] = ptr[0] + 1;
            ...
            else if(attempt == 5)
            {
                ...
                clcd_write(0x0C, 0);
                clcd_write(0x01, 0);
                clcd_print("Password Failed",(0x80 + 0));
                clcd_print("Reset your board",(0xC0 + 0));
                flag1 = 1;

            }

            else if(key == 0xFF && count == 0 && once)
            {
                once = 0;
                clcd_write(0x01, 0);
