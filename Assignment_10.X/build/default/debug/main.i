...
void main(void) {
    ...
    unsigned char ssd[4], key, prekey = 0x3F;
    unsigned char vals[12] = {0x3F, 0x06, 0x5B, 0x4F, 0x66, 0x6D, 0x7D, 0x07, 0x7F, 0x6F, 0x08, 0x08};
    ...
    while (1)
    {
        ...
        {
            wait = 0;
            if((prekey == 0x3E || prekey == 0x3F) && hold == 0)
            {
                left = 1;
                right = 0;
                if(once)
