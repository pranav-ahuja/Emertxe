...
#define DISP_ON_AND_CURSOR_ON1      clcd_write(0x0E, INST_MODE)
#define SHIFT_CURSOR_LEFT1			clcd_write(0x10, INST_MODE)
#define SHIFT_CURSOR_RIGHT1			clcd_write(0x14, INST_MODE)
